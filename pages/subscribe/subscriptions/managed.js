  ...
  return (
    <div className="flex mr-2 relative rounded-md">
      <input
        ...
        name="account"
        id="account"
        className="w-96 focus:ring-indigo-500 shadow-md focus:border-indigo-500 block pl-7 p-4 sm:text-sm border-gray-300 rounded-md text-black"
        placeholder="Put the subscribers given email here to confirm proof"
      />
      <Button
        onClick={() => {
          onVerify(email);
...
const ManagedCourses = () => {
  ...
  //changed account to account.data
    ...
    <>
      ...
      <section className="grid grid-cols-1 bg-black text-white">
        ...
        {filterCourses?.length === 0 && (
          <Message type="warning">Nothing to display.</Message>
        )}
