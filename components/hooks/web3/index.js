...
const enhanceHook = swrResponse => {
  // This function uses swrResponse bc that is what will be wrapping the hook. The hook will get data and mutate it. It takes the swrResponse and adds two new properties to it, isEmpty and hasInitialResponse. enhanceHook then wraps the other hooks and passes these new properties to each one to be used as needed.
  // debugger
...
export const useWalletInfo = () => {
  ...
  //tells if CONNECTING to metamask wallet - passed to Marketplace to render button msg conditionally and disable it
  const isConnecting =
