          ...
          lg:-mx-8">
            ...
            ">
              <div className="shadow overflow-hidden border-2 border-gray-200 sm:rounded-lg">
                <div className="min-w-full divide-y divide-gray-200 border-2 rounded-lg
                xs:w-[94vw]
                ...
                ">
                  ...
                  <div className="bg-[#2b2b2b] divide-y divide-white">
                      ...
                      <div>
                        ...
                        <a target="_blank" rel="noreferrer" href="https://www.google.com" className="text-green-600 hover:text-green-900">Read Now</a>               
