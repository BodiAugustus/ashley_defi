...
const Call2Action = () => {
  return (
    ...
    >
      ...
      <div
        className="sm:h-[88vh] w-[90vw] bg-[#2b2b2b] mx-auto rounded-lg white-glassmorphism p-3
            sm:p-5
            md:h-[65vh]
            lg:h-[70vh]
            2xl:h-[55vh]
      ...
      >
        ...
        <h4
          className="text-center mt-4
                ...
                "
        >
          That&apos;s it. No annual subscriptions, no hidden fees or extra costs
          of any kind. Just one flat fee per month to gain unlimited access to
          your very own DeFi consultant and wealth manager.
          <br />
          <br />
          <div className="indent-4">
            {' '}
            We live and breath DeFi and we code on, develop, and use the
            technologies that we write every day.
          </div>
          <br /> &nbsp;&nbsp;&nbsp;&nbsp;We are real blockchain developers using
          the latest technologies to build a more decentralized future for all.
          Let us show you the ropes so that you can also learn how to take
          advantage of the financial revolution that is happening all around
          you.
        </h4>
      </div>
      <div
