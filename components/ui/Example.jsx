        ...
        <div className="h-[100vh] bg-black text-white ">
            ...
            <div className="h-[89vh] w-[90vw] bg-[#2b2b2b] mx-auto border-2 rounded-xl border-stone-500 grid grid-cols-1 ">
                ...
                <div className=" rounded-lg p-2 mt-1 overflow-y-scroll">
                    ...
                    <h2 className="indent-4 ">Have you been wondering why Bitcoin and Ethereum have been going down instead of up lately? Follow along with us here at Ashley DeFi and let us show you one side of the coin.
                    <GiTwoCoins className='absolute bottom-[4%] left-[37%]'/> 
                    </h2>
                     
                    </div> 
                    <br/>
                    <h2>To begin our foray into the details we must first talk about the concept which I&apos;m sure most, if not all of you have by now heard about many times before. It is one of the main reasons why Ethereum has and continues to lose so much of its previous market share to competitors which allow for much cheaper transactions, such as FTM or ATOM.<br/><br/>

                    <h2>Gas is required to run functions which result in changes to the blockchain, such as a transfer function to send Ether from one person to another. Gas fees also prevent infinite looping from taking place inside of smart contracts which can be used by malicious actors to stop or cause disfunctions to the contract while running.</h2> <br/>
                    
                    <h2>On the Ethereum blockchain this sort of transfer transaction has a set price for gas which is 20 billion wei. Other types of interactions/transactions have different set prices depending on many parameters, such as network congestion.</h2><br/><br/>

                   <h2> 1 wei = 1 wei<br/>
                    1 Gwei = 1 billion wei<br/>
                    1 Ethereum = 10^18 wei</h2><br/><br/>

                   <h2 className='indent-4'> So, you wanting to transfer some Ethereum to X will make the gas price 21000 Gwei because it is a transfer transaction. Now, depending on the network congestion it will take more or less gas in order to get your transaction picked up from the transaction pool by the block miners and then written onto the block. The price of gas will remain the same, but how much you need to fulfill the transaction will depend on the network congestion and how fast you need it to go through.</h2><br/>

                    <h2>You must set a Gas Limit (pay a transaction fee) which will determine HOW MUCH of that 21000 Gwei gas you are willing to purchase to get your transaction to go through. <br/><br/>
                    Paying less money means your transaction takes more time and if it is not enough, then the transaction may be left in the block pool entirely and stay unwritten to the block until the transaction fails which will eat up all of your gas fees and then revert back whatever transaction you just tried to do after the loss of said fees - this means you are back at square one, only you lost your gas money too.</h2><br/>
                    ...
                    <h2 className='indent-4'>So then the best strategy is to pay a mid amount if you are making regular trades/transactions in times of non-high volatility or congestion, or, if you are making important trades during high volume, to pay above the market cost for gas to ensure your transactions gets picked first by the miners and added into the blockchain to be confirmed without delay.</h2><br/>
                    ...
                    <h2 className='indent-4'>Remember - it takes multiple transactions to buy and swap coins on the blockchain. When using Ethereum or Fantom going to a token swap like Uniswap or SpiritSwap, it will take one transaction to give wallet permission, one transaction to purchase the token, one transaction to gain access to the liquidity pools, one transaction to add into those liquidity pools to begin earning yields, and then more transactions to exit the pools or swap into stable coins during downturns or to send to offline wallets for better storage.</h2><br/>
                    ...
                    <h2>This is just an example of the sort of information, knowledge, and experience you will gain access to with Ashley Capital & DeFi and we&apos;ve only just skimmed the surface!</h2><br/>

                    <h2>Come join us and let us teach you what we know!</h2>
                </div>
