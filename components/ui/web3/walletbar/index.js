//This is the header component on the subscribe/member page
...
const WalletBar = () => {
  ...
  return (
    <section className="text-white bg-[#2b2b2b] rounded-bl-lg rounded-br-lg">
      ...
      "
      >
        <h1 className="xs:text-sm md:text-2xl">
          Hello,{' '}
          {account ? account.data?.slice(0, 6) : "guest, you're not logged in!"}
        </h1>
        <div
          className="flex xxs:flex-col
        md:flex-row
        ...
        md:text-xl"
          ...
          <button
            ...
            "
          >
            <AiOutlineWarning className="mr-2" /> Read First!
          </button>
        </div>
        <div
        ...
        >
          <div
            className="bg-black p-4 rounded-lg border-2 border-sky-400
          xxs:mb-2
          ...
          >
            <div className="text-center">
              <h2>Today is {dayjs().format('dddd')}</h2>
            </div>
            <div className="text-center">
          ...
          xs:text-center xs:mb-5"
            ...
            {network.data && (
              <div className="xs:text-center">
                ...
                {/*This conditionally renders so that when a user does not have metamask installed the currently on message does not appear to UI*/}
              </div>
            )}
          </div>
        </div>
