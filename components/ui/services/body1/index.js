...
const Body1 = () => {
    return (
        ...
        <div className="h-[100vh] bg-black text-white px-3">
            ...
            <div className="flex items-center mb-2 font-economica">
            <FaSkullCrossbones className='text-4xl mr-1'/>
            <h2>That most Twitter crypto influencers get paid by developers to shill projects before liquidating as the newcomers arrive and drive the price up before the crash.</h2>
            </div>
            <div className="flex items-center mb-2 font-economica">
            ...
            <h2>Despite these risk and more however there really is no question, DeFi is the future and the future has begun - Come join with us!</h2>
            </div>
