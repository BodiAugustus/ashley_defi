        ...
        <div className="h-[100vh] bg-black text-white ">
            ...
            <div className="col-span-2 row-span-3 rounded-xl p-4 font-light ">
                ...
                md:text-3xl md:p-8">
                    ...
                    <h2 className="md:indent-8">Our aim is to bridge the knowledge gap between the general public and those who code on the blockchains and interact with its protocols daily.</h2><br/>
                    <h2></h2>
                </div>
